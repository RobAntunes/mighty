            ...
            <div style={styles.cardContent}>
                ...
                <div style={styles.cardInfo}>
                    <h3 style={styles.itemTitle}>
                        {app.name[0].toUpperCase() + app.name.substring(1)}
                    </h3>
                    <p style={styles.itemDescription}>
                        {app.description.substring(0, 100) +
                            (app.description[app.description.length - 1] === "."
                                ? ""
                                : "...")}
                    </p>
                </div>
...
export class ApiDockWidget extends BaseWidget {
    ...
    protected onActivateRequest(msg: Message): void {
        ...
        const searchInput = this.node.querySelector(
            "input",
        ) as HTMLInputElement;
        if (searchInput) {
            searchInput.focus();
